...
class CreateUserComponent extends Component {
  ...
  saveOrUpdateUser = (e) => {
    ...
    console.log("report => " + JSON.stringify(user));
  ...
  getTitle() {
    if (this.state.id === "_add") {
      return <h3 className="judul text-center">Add transaction</h3>;
    } else {
      return <h3 className="judul text-center">Update transaction</h3>;
    }
  }
